...
| `/admin`                                      | Админ-панель: обзор и статистика (только для администраторов)              |
| `/admin/users`                                | Пользователи: поиск, редактирование, права, удаление                       |
| `/admin/universities`                         | Вузы и факультеты: CRUD                                                    |
| `/admin/programs`                             | Программы: CRUD и фильтры                                                  |
| `/admin/statements`                           | Заявки: список и смена статуса                                             |
| `/admin/materials`                            | Материалы: CRUD, публикация/черновик                                       |
